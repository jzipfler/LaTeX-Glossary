% The glossary/acronym entries will only appear
% if they get used in the document, so it is possible,
% to include the glossary in every document you want to.
...
\input{glossary/acronyms/acronyms}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% GLOSSARY
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\input{glossary/glossary/glossary_de}
