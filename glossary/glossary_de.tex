...
\newglossaryentry{Mean opinion score}{
	name={Mean opinion score},
	description={wird verwendet, um die Qualität von Telefonverbindungen zu bewerten. Dabei können Werte von 0 bis 5 angenommen werden, wobei mittels \acrshort{ISDN} ein MOS-Wert von ungefähr 4,5 und \acrshort{VoIP} ein MOS-Wert zwischen ungefähr 3,9 und 4,4, je nach Codec, erreicht werden kann}
}
